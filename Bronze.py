...
bronze_2014 = date_2014_complete.write.mode("append").format("delta").partitionBy("vendor_id").save("abfss://bronze-artin@datacohortworkspacelabs.dfs.core.windows.net/2014")
bronze_2019 = date_2019_complete.write.mode("append").format("delta").partitionBy("VendorID").save("abfss://bronze-artin@datacohortworkspacelabs.dfs.core.windows.net/2019")
