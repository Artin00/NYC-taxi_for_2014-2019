...
display(bronze_2014_done_fin.limit(10))

# COMMAND ----------

#Saving the dataframe to the silver container
silver_2019 = bronze_2019_lols.write.mode("append").format("delta").partitionBy("vendor_id").save("abfss://silver-artin@datacohortworkspacelabs.dfs.core.windows.net/DataSet")
