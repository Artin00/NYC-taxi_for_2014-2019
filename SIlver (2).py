...
silver_2019 = bronze_2019_lols.write.mode("append").format("delta").partitionBy("vendor_id").save("abfss://silver-artin@datacohortworkspacelabs.dfs.core.windows.net/2019")
